...
// pins definition
#define GSM_ON               12// connect GSM Module turn ON to pin 77  8
#define GSM_RESET            12// connect GSM Module RESET to pin 35     9
...
public:
    ...
    HWSerial _cell;
     ...
     char WritePhoneNumber(byte position, char *phone_number,char *name);
